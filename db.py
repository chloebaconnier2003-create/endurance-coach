...
CREATE TABLE IF NOT EXISTS work_cycles (id INTEGER PRIMARY KEY AUTOINCREMENT,title TEXT NOT NULL,anchor_date TEXT NOT NULL,cycle_days INTEGER DEFAULT 28,active INTEGER DEFAULT 1,notes TEXT);
